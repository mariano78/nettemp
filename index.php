...
if($nts_info=='on') {
?>
<li <?php echo $id == 'info' ? ' class="active"' : ''; ?>><a href="info"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"> Info</span></a></li>
<?php
	}
	?>
...
<li><a href="index.php?id=tools&type=update"><span class="glyphicon glyphicon-cloud-download" aria-hidden="true"> <span class="btn btn-xs btn-primary">Update available!</span></span></a></li>
