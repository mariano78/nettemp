...
<?php       
	...
	if(isset($_SESSION['user'])){ $link='<a href="index.php?id=creports&crom=<?php echo $a["rom"]; ?>" title="Go to report"><img src="media/ico/gas-icon.png" alt=""/>'} else{
...
<tr>
    <td>
    <?php if($a['type'] == 'gas'){ echo $link $units='m3'; $units2='L';} ?></a>
    <?php if($a['type'] == 'water'){ echo $link $units='m3'; $units2='L'; } ?></a>
    <?php if($a['type'] == 'elec'){ echo $link $units='kWh' ; $units2='W';} ?></a>
    <small>
	<?php 
