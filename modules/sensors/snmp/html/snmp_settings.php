...
$snmp_add1 = isset($_POST['snmp_add1']) ? $_POST['snmp_add1'] : '';
    ...
    $dbn->exec("INSERT OR IGNORE INTO sensors (name, rom, type, tmp, device, map_pos, map_num, adj, charts) VALUES ('$snmp_name','$rom','$snmp_type', 'wait', 'snmp', '{left:0,top:0}', '$map_num', 0, 'on')") or die ("cannot insert to DB 2" );
