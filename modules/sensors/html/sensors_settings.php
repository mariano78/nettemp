...
<tr>
    ...
    <select name="ch_groupon" class="form-control input-sm small" onchange="this.form.submit()" style="width: 90px;" >
		<?php
			$unique1=array();
			$unique1[]='sensors';
			$unique1[]=$a['type'];
	...
	<a href="index.php?id=<?php echo $id ?>&type=devices&device_group=<?php echo $device_group?>&device_type=<?php echo $device_type?>&device_menu=expand_device&device_id=<?php echo $device_id; ?>&device_rom=<?php echo $a["rom"]; ?>" ><button class="btn btn-xs btn-info">Settings</button></a>
	<a href="index.php?id=<?php echo $id ?>&type=devices&device_group=<?php echo $device_group?>&device_type=<?php echo $device_type?>&device_menu=notifications&device_id=<?php echo $device_id; ?>&device_rom=<?php echo $a["rom"]; ?>" ><button class="btn btn-xs btn-info">Notifications</button></a>
	</td>
