...
<tbody>
	...
	<tr>
		<td>
		<a href="index.php?id=<?php echo $id ?>&type=devices&device_group=<?php echo $device_group?>&device_type=<?php echo $device_type?>&device_menu=settings&device id=<?php echo $a["id"]; ?>" ><button class="btn btn-xs btn-info">Back</button></a>
		</td>
	</tr>
