...
if(file_exists("db/".$new_rom.".sql")&& filesize("db/".$new_rom.".sql")!=0){
	...
	$db->exec("UPDATE sensors SET tmp='0', adj='0', charts='on', sum='0', position='1', status='on', ch_group='$type',position_group='1',logon='off', thing='off', ghide='off', hide='off', latitude='$nts_lat', longitude='$nts_long', readerrtime='60', tobase='on', influxdb='off', prec='1' WHERE rom='$new_rom'");
