...
<td class="col-md-1">
	...
	<form action="" method="post" style="display:inline!important;">
		<input type="text" name="script_path" size="20" maxlength="50" value="<?php echo $tr["script"]; ?>" />
		<button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span> </button>
...
<td class="col-md-1">
	...
	<form action="" method="post" style="display:inline!important;">
		<input type="text" name="script_path1" size="20" maxlength="50" value="<?php echo $tr["script1"]; ?>" />
		<button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span> </button>
