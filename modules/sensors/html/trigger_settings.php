...
<form action="" method="post" class="form-inline" style="display:inline!important;"> 
		...
		<?php foreach ($labels as $color) { ?>
			<option class="<?php echo 'label '.$color.'"'?> value="<?php echo $color; ?>"<?php echo $tr['trigzeroclr'] == $color ? 'selected="selected"' : ''; ?>><?php echo "<span class=\"label ".$color."\">".$color."</span>"; ?></option>
		<?php } ?>
