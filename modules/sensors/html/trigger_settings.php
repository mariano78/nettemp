...
<form action="" method="post" class="form-inline" style="display:inline!important;"> 
		...
		<?php foreach ($labels as $color) { ?>
			<option class="<?php echo $color; ?>" value="<?php echo $color; ?>"<?php echo $tr['trigzeroclr'] == $color ? 'selected="selected"' : ''; ?>><span class="label label-default"><span class="<?php echo $color; ?>"><?php echo $color; ?></span></option>
		<?php } ?>
		...
		<?php foreach ($labels as $color) { ?>
			<option value="<?php echo $color; ?>"<?php echo $tr['trigoneclr'] == $color ? 'selected="selected"' : ''; ?>><?php echo $color; ?></option>
		<?php } ?>
		</select>
