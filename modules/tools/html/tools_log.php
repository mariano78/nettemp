...
<p>
<a href="index.php?id=tools&type=log&log=nettemp" ><button class="btn btn-xs btn-default <?php echo $log == 'nettemp' ? 'active' : ''; ?>">Nettemp</button></a>
<a href="index.php?id=tools&type=log&log=call" ><button class="btn btn-xs btn-default <?php echo $log == 'call' ? 'active' : ''; ?>">Call</button></a>
...
<a href="index.php?id=tools&type=log&log=piups" ><button class="btn btn-xs btn-default <?php echo $log == 'piups' ? 'active' : ''; ?>">PiUPS</button></a>
</p>
<?php  
switch ($log)
{ 
...
case 'piups': include('modules/tools/html/log/log_piups.php'); break;
}
?>
