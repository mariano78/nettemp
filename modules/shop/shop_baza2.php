...
(!empty($filtr_kod)) ? $sql  .= "AND JFOX_TOWAR_KARTOTEKI.TO_KOD LIKE '$filtr_kod'";

$sql .= "AND (JFOX_RB_TOWAR_KARTOTEKI.TO_STATUS_HANDL LIKE 'spr' OR JFOX_RB_TOWAR_KARTOTEKI.TO_STATUS_HANDL LIKE 'spz' OR JFOX_RB_TOWAR_KARTOTEKI.TO_STATUS_HANDL LIKE 'wyp')
...
?>
			<tr>	
				...
				<td class="col-md-0">
					...
					<form action="" method="post" style="display:inline!important;">
						<input type="text" name="name_new" size="70" maxlength="320" value="<?php echo $shop_name; ?>" />
						<button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span> </button>
