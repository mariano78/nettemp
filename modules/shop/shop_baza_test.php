			...
			<tr>	
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="kategoria" class="form-control input-sm small" onchange="this.form.submit()" style="width: 300px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="kategoria2" class="form-control input-sm small" onchange="this.form.submit()" style="width: 300px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="dostawa" class="form-control input-sm small" onchange="this.form.submit()" style="width: 100px;" >
