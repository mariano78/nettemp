			...
			<tr>	
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="kategoria" class="form-control input-sm small" onchange="this.form.submit()" style="width: 150px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="kategoria2" class="form-control input-sm small" onchange="this.form.submit()" style="width: 150px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="dostawa" class="form-control input-sm small" onchange="this.form.submit()" style="width: 60px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="dostawa3" class="form-control input-sm small" onchange="this.form.submit()" style="width: 60px;" >
				...
				<td class="col-md-0">
					<a target="_blank" style="display:inline!important;" class="btn btn-xs <?php $ilezn = strlen($to_opis); echo $ilezn; if (strlen($to_opis) <= $to_opis_lenght) {echo 'btn-danger';} else {echo 'btn-success';} ?> glyphicon glyphicon-text-background" href="<?php echo $link_prod_desc ?>"></a>
				</td>
			</tr>
