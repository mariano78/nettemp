			...
			<tr>	
				...
				<td class="col-md-0">
					...
					<form action="" method="post"  class="form-inline">
						<select name="kategoria" class="form-control input-sm small" onchange="this.form.submit()" style="width: 250px;" >
				...
				<td class="col-md-0">
					...
					<form action="" method="post" style="display:inline!important;">
						<input type="text" name="pow_new" size="40" maxlength="254" value="<?php echo $shop_pow; ?>" />
						<button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span> </button>
				...
				<td class="col-md-0">
					<a target="_blank" style="display:inline!important;" class="btn btn-xs <?php if (strlen($to_opis) <= 1000) {echo 'btn-danger';} else {echo 'btn-success';} ?> glyphicon glyphicon-text-background" href="<?php echo $link_prod_desc ?>"</a>
				</td>
			</tr>
