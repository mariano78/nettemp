...
?>
	...
	<td>
	<form action="" method="post" style="display:inline!important;">
	<label>New:</label><input type="password" name="pass1" size="10" maxlength="30" value=""  required=""/>
	
	
	
	<label>Repeat:</label><input type="password" name="pass2" size="10" maxlength="30" value="" required=""/>
	<button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span> </button>
	</form>
	</td>
