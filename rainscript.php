...
// Calculate kWh to use - import from PV system  - kWh*0,8
		  ...
		  $query = $db2->query("SELECT sum from sensors WHERE rom = 'usb_ttyUSB0a1_elec'");
          $result = $query->fetchAll();
		  ...
		  $query = $db2->query("SELECT sum from sensors WHERE rom = 'usb_ttyUSB0a1EXP_elec'");
          $result = $query->fetchAll();
